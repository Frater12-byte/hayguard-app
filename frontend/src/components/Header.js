    ...
    <header className="app-header">
      <div className="header-left">
        ...
        <div className="page-title">
          ...
          <p>{formatGreeting()}, {user?.name || 'Farmer'}!</p>
        </div>
      </div>
      ...
      <div className="header-right">
        <div className="header-actions">
          ...
          <button className="action-btn search">
            <svg viewBox="0 0 24 24" fill="currentColor">
              <path d="M15.5 14h-.79l-.28-.27A6.471 6.471 0 0 0 16 9.5 6.5 6.5 0 1 0 9.5 16c1.61 0 3.09-.59 4.23-1.57l.27.28v.79l5 4.99L20.49 19l-4.99-5zm-6-8C7.01 6 5.5 7.51 5.5 9.5S7.01 13 9.5 13 13.5 11.49 13.5 9.5 11.99 6 9.5 6z"/>
            </svg>
          </button>
        </div>
